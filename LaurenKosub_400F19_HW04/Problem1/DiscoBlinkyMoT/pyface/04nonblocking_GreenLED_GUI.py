#04nonblocking_GreenLED_GUI.py wmh 2019-06-09 : removes 'rxline' blocking call. Used for debugging MoT messaging
...
import Cmd_hexlify
root = tk.Tk()
ser = serial.Serial('COM47',9600) #change for other ports, bauds.  see http://pyserial.readthedocs.io/en/latest/pyserial_api.html --
